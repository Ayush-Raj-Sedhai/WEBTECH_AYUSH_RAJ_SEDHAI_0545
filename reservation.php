...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    ...
    <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel">
                <div class="panel-heading">Room Information:
                  <a class="btn btn-info pull-right" href="index.php?room_mang">Room</a>
                </div>
                <div class="panel-body">
                 ...
                 <!--  <div class="col-lg-12">
                    ...
                    <h4 style="font-weight: bold">Price: <span id="price"><?php  $get_room_price; ?></span> /-</h4>
      ...
      <div class="row">
        <div class="col-sm-12">
          <p class="back-link">HMS Developed by <a href="">Ayush</a></p>
        </div>
      </div>
      </div>    <!--/.main-->
