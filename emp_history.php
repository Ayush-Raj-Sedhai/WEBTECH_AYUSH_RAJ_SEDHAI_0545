        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    ?>
                    <p><b>Hiker Name: </b> <?php echo $employee['emp_name']; ?></p>
                    <p><b>Total Hike Attain: </b> <?php echo $employee['salary'].'/-'; ?></p>
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <th>Sr. No</th>
                            <th>Room no </th>
                            <th>Hike Attain Date</th>
                            <th>Last Hike Attain Date</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($staff['to_date'] == NULL){
                                            echo "<div class='color-blue'>Currently Attain Hike</div>";
                                        }else{
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Hiker Detail</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Hiker Detail:</div>
                                    <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <select class="form-control" id="staff_type" name="staff_type_id"
                                                            required>
                                                        <option selected disabled>Select Hiker Type</option>
                                                        <?php
