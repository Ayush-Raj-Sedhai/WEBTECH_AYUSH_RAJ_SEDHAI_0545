        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Room Details:
                    <a href="index.php?add_emp" class="btn btn-info pull-right">Add Room</a>
                </div>
                <div class="panel-body">
                    <?php
                    if (isset($_GET['error'])) {
                        echo "<div class='alert alert-danger'>
                                <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Error on Catagories Change !
                            </div>";
                    }
                    if (isset($_GET['success'])) {
                        echo "<div class='alert alert-success'>
                                <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Catagories Successfully Changed!
                            </div>";
                    }
                    ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#changeShift"
                                                data-id="<?php echo $staff['emp_id']; ?>" id="change_shift">Change Room Type</button>
                                    </td>
                                    <td>
                                        ...
                                        <a href='index.php?emp_history&empid=<?php echo $staff['emp_id']; ?>'
                                           class="btn btn-success" title="Hiker Histery"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="panel-body">
                                        <form data-toggle="validator" role="form" action="ajax.php" method="post">
                                            ...
                                            <div class="form-group col-lg-12">
                                                <label>Select Room Catagory</label>
